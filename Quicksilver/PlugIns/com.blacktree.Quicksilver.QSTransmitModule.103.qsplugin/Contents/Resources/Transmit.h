...
+ (TransmitApplication *) application;
...
// A document.
@interface TransmitDocument : SBObject
...
// A window.
@interface TransmitWindow : SBObject
...
// A tab in Transmit.
@interface TransmitTab : SBObject

- (SBElementArray *) fileBrowsers;
...
@interface TransmitFileBrowser : SBObject

- (SBElementArray *) browserItems;
- (SBElementArray *) selectedBrowserItems;
...
@interface TransmitSkipRule : SBObject
...
@interface TransmitBrowserItem : SBObject
